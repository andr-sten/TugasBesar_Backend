...
<footer class="w-full text-center py-6 mt-auto">
    <p class="font-body-md text-[10px] text-slate-400 font-medium">© 2026 STMIK WIDYA UTAMA PURWOKERTO.</p>
</footer>
@endsection
